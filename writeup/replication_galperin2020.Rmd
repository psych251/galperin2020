...
Results of the effect size calculation for the second t-test (calculated by using mean and s.d.) was as follows: `Cohen's d = 0.6554`,  `effect-size r = 0.3114`. I conducted the effect size calculation using the t-value and df as well and obtained very similar results.

Based on the effect size, I conducted a power analysis for samples. Results for the power analysis for 80%, 90%, 95% power are as follows:
...
The sample consists of 123 participants recruited from Prolific. In order to participate in the study, individuals should have an experience hiring people for the organization because this study addresses job decision making processes of hiring managers in the labor market. 
\
...
For this replication, the original work's procedure (described above in quotation) was followed precisely.

\

#### Link:

* Survey for Pilot B: [Link to the survey for Pilot B](https://stanforduniversity.qualtrics.com/jfe/preview/SV_d4LnrTl3Leh1WDQ?Q_CHL=preview&Q_SurveyVersionID=current)



###Analysis Plan (EDITING)
