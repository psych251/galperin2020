...
```
(JIWON)
I plan to delete all the codes and results from Pilot A from the manuscript and make descriptive statistics and figures Appendix, if that's okay. I think it's cleaner to include only the data from the actual study and not include pilots in the report. If it's better practice to include pilots, I want to have them as Appendix.
```
...
Below are the key analyses results from Pilot A.
\
